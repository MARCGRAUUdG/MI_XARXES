...
/* Fitxer ser.c que implementa el client de MI sobre la capa de           */
...
/* Incloem "MIp1v2-t.h" per poder fer crides a la "nova" interfície de    */
/* la capa de transport o "nova" interfície de sockets.                   */
#include "MIp1v2-t.h"
